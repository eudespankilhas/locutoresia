...
# Testar o arquivo mais recente gerado pela API
def test_latest_generated():
    print("Testando arquivo mais recente gerado pela API...")
            ...
            if n_frames > 0:
                ...
                if len(frames) > 0 and sample_width == 2:
                    ...
                    if max_val == 0:
                        ...
                        print("O servidor pode não ter reiniciado com as mudanças...")
                    else:
