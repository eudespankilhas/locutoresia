...
# Testar diretamente a função generate_speech
def test_generate_speech():
    print("Testando função generate_speech diretamente...")
    ...
    try:
        ...
        # Salvar para análise
        filename = "direct_test_audio.wav"
...
if __name__ == "__main__":
    success = test_generate_speech()
    if success:
        print("\n=== RESULTADO ===")
        print("Função generate_speech está funcionando!")
    else:
        print("\n=== RESULTADO ===")
        print("Função generate_speech tem problemas!")
